...
namespace SGCUI
{
    public partial class AlmacenCarga : MetroFramework.Forms.MetroForm
    {
        ...
        void LoadAlmacenes()
        {
            if (BLL.getAgentes() != null)
            {
                ...
                {
                    metroComboBoxAlmacen.Items.Add(ls.Id);
                }
            }
        }
        ...
        {
            var temp = new SGCBLL.AlmacenCarga(int.Parse(metroComboBoxAlmacen.Text), int.Parse(metroComboBoxCarga.Text), dateTimePicker1.Value, dateTimePicker2.Value);
